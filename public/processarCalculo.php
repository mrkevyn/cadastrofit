...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Calcular percentual de gordura com base na fórmula escolhida
    switch ($formula_escolhida) {
        ...
        case 'percentual_gordura_meninas':
            ...
            break;
        default:
            echo json_encode(['error' => 'Fórmula desconhecida.']);
            exit;
    }

    if ($resultado !== null) {
        // Inserir os resultados na tabela 'calculadora'
